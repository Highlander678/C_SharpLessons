...
namespace Methods
{
    ...
    {        
        ...
        static void Main()
        {
            ...
            Operation("NewVal");             // 2-я перегрузка.
            Operation("NewVal", 20);         // 3-я перегрузка. 
            Operation("NewVal", 20, 3.14);   // 4-я перегрузка.
            ...
            Operation("NewVal", value3: 3.14);
            Operation(value2: 20, value3: 3.14);
