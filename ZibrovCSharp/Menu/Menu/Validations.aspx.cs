...
// Web-страница проверяет ввод пользователем имени, e-mail-адреса, URL-адреса и
// пароля, например, при регистрации пользователя. Причем если страница
// (Web-форма) успешно прошла все этапы проверки, то направляем пользователя на
// другую, уже разрешенную для этого пользователя, Web-страницу.
using System;
